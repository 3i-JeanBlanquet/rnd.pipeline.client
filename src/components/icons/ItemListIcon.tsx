...
const ItemListIcon: React.FC<{ size?: number; color?: string }> = ({ 
  size = 20, 
  color = '#666' 
}) => {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M9 12H15M9 16H15M9 8H15" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
};
